 ...
 * @author PC-9
 */
public class reporrterForm extends javax.swing.JFrame {

    /**
     * Creates new form reporrterForm
     */
    public reporrterForm() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(reporrterForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new reporrterForm().setVisible(true);
            }
        });
    }
